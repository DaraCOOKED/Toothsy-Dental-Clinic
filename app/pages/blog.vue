<template>
  ...
  >
    ...
    >
      ...
      >
        <source src="/video/hero-blog.mp4" type="video/mp4">
      </video>
 ...
 <section
    ref="sectionRef"
    class="relative bg-[#FFFAE1] py-20 px-6 md:px-10 transition-all duration-700 ease-out"
    :class="visible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'"
  >
    <div class="max-w-6xl mx-auto">
      <div class="text-center mb-10">
        <h2 class="font-display text-3xl md:text-4xl font-bold text-[#111827]">From the Blog</h2>
